...
SELECT DISTINCT cost.USER_NAME, cost.WAREHOUSE_GROUP_NAME, SUM(cost.CREDITS_USED) as total_credits_used, SUM(cost.DOLLARS_USED) as total_dollars_used, cost.MEASURE_TYPE, cost.START_TIME, cost.END_TIME  from (
SELECT DISTINCT
...
) as COST group by 6, 7, 1, 2, 5 order by 4 desc
;
