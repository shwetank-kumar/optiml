...
SELECT DISTINCT cost.WAREHOUSE_NAME, cost.WAREHOUSE_GROUP_NAME, cost.MEASURE_TYPE, SUM(cost.CREDITS_USED) as total_credits_used, SUM(cost.DOLLARS_USED) as total_dollars_used, cost.START_TIME, cost.END_TIME  from (
SELECT DISTINCT
...
) as COST group by 6, 7, 1, 2, 3 order by 5 desc
;
