...
SELECT DISTINCT cost.WAREHOUSE_NAME, cost.WAREHOUSE_GROUP_NAME, cost.MEASURE_TYPE, SUM(cost.CREDITS_USED) as credits_used, TIMESTAMPDIFF('hour', cost.START_TIME, cost.END_TIME) as duration, cost.START_TIME  from (
SELECT DISTINCT
...
) as COST group by 6, 1, 2, 3, 5 order by 6 asc
;
