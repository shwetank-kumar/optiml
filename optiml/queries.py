...
class SNFLKQuery():
    ...
    def total_cost_breakdown_ts(self, start_date='2022-01-01', end_date='', aggregation_period='weekly'):
    ##TODO: Total cost breakdown across each of the areas captured in the total_cost_breakdown function 
    # but aggregated weekly (with option of monthly, quarterly, yearly). Output will be same as the dataframe
    # in total_cost_breakdown function but with additional columns for the aggregation period.
        pass

    ##TODO Update this query and make it less adhoc
